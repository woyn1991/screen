...
public class DrawRectangle implements Cloneable {
    ...
    public void draw( Graphics2D g2d ) {
        ...
        g2d.fillRoundRect( rectangle.x + rectangle.width - DRAW_RECT_FONT_METRICS.stringWidth( endCoord ) - 11,
                ...
                DRAW_RECT_FONT_METRICS.stringWidth( endCoord ) + 9,
                DRAW_RECT_FONT_METRICS.getHeight() + 4, 14, 14 );
        ...
        if ( name != null ) {
            ...
            g2d.fillRoundRect( 
                    ...
                    DRAW_RECT_FONT_METRICS.stringWidth( name ) + 9,
                    DRAW_RECT_FONT_METRICS.getHeight() + 4, 14, 14 );
        ...
        g2d.drawString( endCoord,
                rectangle.x + rectangle.width - DRAW_RECT_FONT_METRICS.stringWidth( endCoord ) - 9,
                rectangle.y + rectangle.height - DRAW_RECT_FONT_METRICS.getHeight() + 9 );
